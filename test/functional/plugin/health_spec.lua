...
describe(':checkhealth window', function()
  ...
  it('opens directly if no buffer created', function()
    ...
    screen:set_default_attr_ids {
      ...
      [21] = {foreground = tonumber('0x6a0dad')};
      [22] = {foreground = Screen.colors.PaleGreen2};
    }
    ...
    ## grid 2
      ...
      {14:──────────────────────────────────────────────────}|
      {14:────────────────────────────}                      |
      {21:test_plug.success1: require("test_plug.success1.  }|
      {21:health").check()}                                  |
                                                        |
      {21:report 1}                                          |
      - {22:OK} everything is fine                           |
                                                        |
      {21:report 2}                                          |
      - {22:OK} nothing to see here                          |
    ## grid 3
                                                        |
    ]],
    }
  ...
  local function test_health_vsplit(left, emptybuf, mods)
    ...
    ## grid 4
      ...
      {14:─────────────────────────}|*3
      {14:───}                      |
      {21:test_plug.success1:      }|
      {21:require("test_plug.      }|
      {21:success1.health").check()}|
                               |
      {21:report 1}                 |
      - {22:OK} everything is fine  |
                               |

...
/// Get the colors. Don't be happy with -1, get the actual colors.
...
/// Blend overlay attributes (for popupumenu) with other attributes
///
/// This creates a new group when required.
/// As caching is good, we cache the result, for the sake of caching.
/// @return the resulting attributes.

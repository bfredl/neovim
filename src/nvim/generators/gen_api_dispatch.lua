...
table.insert(names, "redraw")
flookup.redraw = {impl_name="ui_client_redraw", fast=true}

local neworder, hashfun = hashy.hashy_hash("msgpack_rpc_get_handler_for", names, function (idx)

...
{
  clear_region(grid, grid->top, grid->bot, grid->left, grid->right, grid->clear_attrs);
}

void ugrid_eol_clear(UGrid *grid)
{
  clear_region(grid, grid->row, grid->row, grid->col, grid->right, grid->clear_attrs);
}
...
void ugrid_scroll(UGrid *grid, int count, int *clear_top, int *clear_bot)
{
  ...
  clear_region(grid, *clear_top, *clear_bot, grid->left, grid->right, grid->clear_attrs);
}
...
static void clear_region(UGrid *grid, int top, int bot, int left, int right, HlAttrs attrs)
{

...
MSG("     i##########+                                                    ;###########*n###@   `##x          ");
MSG("     `@#MM#######x,                                                 ,@#########zM,`z##M   `@#x          ");
MSG("      n##M#W#######n.               `.:i*+#zzzz##+i:.`             ,W#########Wii,`n@#@` n@##n          ");
MSG("      ;###@#x#######n         `,i#nW@#####@@WWW@@####@Mzi.        ,W##########@z.. ;zM#+i####z          ");
MSG("       x####nz########    .;#x@##@Wn#*;,.`      ``,:*#x@##M+,    ;@########xz@WM+#` `n@#######          ");
MSG("       ,@####M########xi#@##@Mzi,`                     .+x###Mi:n##########Mz```.:i  *@######*          ");
MSG("        *#####W#########ix+:`                             :n#############z:       `*.`M######i          ");
MSG("        i#W##nW@+@##@#M@;                                   ;W@@##########W,        i`x@#####,          ");
MSG("        `@@n@Wn#@iMW*#*:                                     `iz#z@######x.           M######`          ");
MSG("         z##zM###x`*, .`                                          `iW#####W;:`        +#####M           ");
MSG("         ,###nn##n`                                                ,#####x;`        ,;@######           ");
MSG("          x###xz#.                                                   in###+        `:######@.           ");
MSG("          ;####n+                                                    `Mnx##xi`   , zM#######            ");
...
MSG("       i########, x#@`  z######;       *##########i *#@`  `+########+`            n######.              ");
MSG("       n#######@` M##,  `W#####.       *#########z  ###;    z########M:           :W####n               ");
MSG("       M#######M  n##.   x####x        `x########:  z##+    M#########@;           .n###+               ");
MSG("       W#######@` :#W   `@####:         `@######W   i###   ;###########@.            n##n               ");
MSG("       W########z` ,,  .x####z           @######@`  `W#;  `W############*            *###;              ");
MSG("      `@#########Mi,:*n@####W`           W#######*   ..  `n#############i            i###x              ");
MSG("      .#####################z           `@#######@*`    .x############n:`            ;####.             ");
MSG("      :####################x`,,`        `W#########@x#+#@#############i              ,####:             ");
MSG("      ;###################x#@###xi`      *############################:              `####i             ");
MSG("      i##################+########M,      x##########################@`               W###i             ");
...
MSG("      i########@.         ,*n#######M*`           `###################M                *##M             ");
MSG("      i########n        `z#####@@#####Wi            ,M################;                ,##@`            ");
MSG("      ;WMWW@###*       .x##@ni.``.:+zW##z`           `n##############z                  @##,            ");
MSG("      .*++*i;;;.      .M#@+`          .##n            `x############x`                  n##i            ");
MSG("      :########*      x#W,              *#+            *###########M`                   +##+            ");
MSG("      ,#########     :#@:                ##:           #nzzzzzzzzzz.                    :##x            ");
MSG("      .#####Wz+`     ##+                 `MM`          .znnnnnnnnn.                     `@#@`           ");
MSG("      `@@ni;*nMz`    @W`                  :#+           .x#######n                       x##,           ");
MSG("       i;z@#####,   .#*                    z#:           ;;;*zW##;                       ###i           ");
MSG("       z########:   :#;                    `Wx          +###Wni;n.                       ;##z           ");
MSG("       n########W:  .#*                     ,#,        ;#######@+                        `@#M           ");
...
MSG("n@@@@@@@#########################+                                                                   `##");
MSG("`      `.:.`.,:iii;;;;;;;;iii;;;:`       `.``                                                        `nW");
MSG("    #xxxn`           #xxnxx`         ,+x@###@Mz;`         .xxxxxxxxxxxnz+,      znnnnnnnnnnnnnnnnnn.    ");
MSG("    n####z           x#####`       :x###########W+`       ,###############M;    W##################.    ");
MSG("    n#####;          x#####`     `z###############W:      ,##################   W##################.    ");
MSG("    n#####W.         x#####`    ,W##################+     ,###################  W##################.    ");
MSG("    n######n         x#####`   ,@#####################    ,###################i W##################.    ");
MSG("    n#######i        x#####`  .W#########@WW@#########*   ,###################W`W##################.    ");
MSG("    n#######@.       x#####`  x#######W*.   `;n########:  ,#####x,,,,,:*M######iW####@:,,,,,,,,,,,,`    ");
MSG("    n########n       x#####` *#######+`        :M######M  ,#####n       `x#####xW####@`                 ");
MSG("    n#########*      x#####``@#####@;           `x######i ,#####n        ,#####@W####@`                 ");
MSG("    n#########@.     x#####`*######i             `M#####M ,#####n         x##########@`                 ");
MSG("    n##########x     x#####`M#####z               :######:,#####n         z##########@`                 ");
MSG("    n###########*    x#####,######.                n#####+,#####n         n##########@`                 ");
...
MSG("    n#####*######M`  x###########*                 `#####@,#####n        i#####MW#################W     ");
MSG("    n#####.#######+  x#####z#####;                  W#####,#####n       i@######W#################W     ");
MSG("    n#####.`W######: x#####n#####:                  M#####:#####@nnnnnnW#######,W#################W     ");
MSG("    n#####. :######M`x#####z#####;                  W#####,###################z W#################W     ");
MSG("    n#####.  ########x###########*                 `#####W,##################W` W#################W     ");
MSG("    n#####.  `M######W#####i#####x                 ;#####x,#################W,  W#####+***********i     ");
MSG("    n#####.   ,@###########,######.                n#####+,################n.   W####@`                 ");
MSG("    n#####.    +###########`M#####z               :######:,#############Wz:     W####@`                 ");
MSG("    n#####.    `x##########`*######i             `M#####M ,#####x......`        W####@`                 ");
MSG("    n#####.     ,@#########``@#####@;           `x######i ,#####n               W####@`                 ");
...
MSG("    n#####.         .@#####`     .n###############W;      ,#####n               W##################,    ");
MSG("    n#####.          i#####`       :x###########W+`       ,#####n               W##################,    ");
MSG("    +nnnnn`           +nnnn`         ,+x@###@Mz;`         .nnnnn+               zxxxxxxxxxxxxxxxxxx.    ");
      }
    }
    goto doend;
  }

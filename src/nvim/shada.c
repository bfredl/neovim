  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  hmll->num_entries--;
  if (hmll_entry->data.can_free_entry) {
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (val) {
    ...
    if (entry.timestamp > existing_entry->data.timestamp) {
      ...
      if (existing_entry->data.can_free_entry) {
  ...
  FUNC_ATTR_NONNULL_ALL FUNC_ATTR_ALWAYS_INLINE
{
  ...
  ret = shada_pack_entry(packer, entry, max_kbyte);
...
static inline size_t shada_init_jumps(ShadaEntry *jumps,

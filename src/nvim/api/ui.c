  ...
  FUNC_API_SINCE(1) FUNC_API_REMOTE_ONLY
{
  ...
  data->packer = (PackerBuffer) {
    ...
    .ptr = NULL,
    .endptr = NULL,
    .flush = ui_flush_callback,
    .anydata = data,  // TODO: silly walk!
  };
...
static void ui_flush_callback(PackerBuffer *packer, size_t size_hint) {
...
void remote_ui_raw_line(UI *ui, Integer grid, Integer row, Integer startcol, Integer endcol,
                        ...
                        const sattr_T *attrs)
{
  assert(sizeof(schar_T) - 1 < 0x20);  // TODO: 
  UIData *data = ui->data;
  if (ui->ui_ext[kUILinegrid]) {

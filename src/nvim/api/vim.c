...
///   If it is an array it should be an array of eight items or any divisor
///   of eight. The array will specifify the eight chars building up the border
///   in a clockwise fashion starting with the top-left corner. As, an example,
...
///     [ "x" ]
///   By default FloatBorder is used which links to VertSplit when not defined.

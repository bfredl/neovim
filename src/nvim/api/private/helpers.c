...
Dictionary api_metadata(void)
{
  ...
  if (!metadata.size) {
    ...
    PUT_C(metadata, "functions", unpack((char *)funcs_metadata, sizeof(funcs_metadata), &arena, &err));
    PUT_C(metadata, "ui_events", unpack((char *)ui_events_metadata, sizeof(ui_events_metadata), &arena, &err));
